...
For example retrieving all groups with cn wich starts with @'dev'@ and has @guid@ == 1:
...
You can build complex queries combining the hash syntax with arrays and @:or@ and @:and@ operators

retrieving all users whose name contains 'john' or cn ends with 'smith' or contains 'liz'
